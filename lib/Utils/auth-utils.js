    ...
    async function commitWithRetry(mutations) {
        ...
        for (let attempt = 0; attempt < maxCommitRetries; attempt++) {
            try {
                ...
                const isExpected = msg.includes('InvalidPreKeyId') || msg.includes('SessionNotFound') || msg.includes('InvalidMessage') || msg.includes('no sender key state') || msg.includes('old counter') || msg.includes('DuplicatedMessage') || msg.includes('BadMac') || msg.includes('Connection Closed')
        ...
        transaction: async (work, key) => {
            ...
            return getTxMutex(key).runExclusive(async () => {
                ...
                try {
                    ...
                    const msg = error?.message || (typeof error === 'string' ? error : '') || ''
                    const isExpected = msg.includes('InvalidPreKeyId') || msg.includes('SessionNotFound') || msg.includes('InvalidMessage') || msg.includes('no sender key state') || msg.includes('old counter') || msg.includes('DuplicatedMessage') || msg.includes('BadMac')
