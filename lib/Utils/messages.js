...
const handleTextMessage = async (message, options) => {
    ...
    if (urlInfo) {
        console.log('highQualityThumbnail:', JSON.stringify(urlInfo.highQualityThumbnail, null, 2))
        Object.assign(extContent, {
            matchedText: urlInfo['matched-text'], jpegThumbnail: urlInfo.jpegThumbnail,
            description: urlInfo.description, title: urlInfo.title, previewType: urlInfo.previewType ?? 0
        })
